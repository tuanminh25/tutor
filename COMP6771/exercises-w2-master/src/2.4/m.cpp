...
Input/Output iterators: can only move forward one step at a time, and you can’t reliably go back or
revisit elements.
...
Random access iterators: have all bidirectional features plus constant-time jumps anywhere in the
sequence (like pointers or vector iterators).
